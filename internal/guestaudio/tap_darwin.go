...
// teamsvideo.FindMeetingWindow). onSamples is called with each batch of
// real, already-downmixed mono float32 samples as they arrive, from an
// arbitrary ScreenCaptureKit-owned thread — keep it fast and
// non-blocking, same contract as the Python original this ports.
